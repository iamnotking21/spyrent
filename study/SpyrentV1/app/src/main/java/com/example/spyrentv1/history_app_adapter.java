...
public class history_app_adapter extends BaseAdapter {
    Context context;
    String domain[],domainid[];
    int parentid,childid;
    LayoutInflater inflater;

    public history_app_adapter(Context acontext, ArrayList<String> domain, ArrayList<String> domainid, int parentid, int childid){
    ...
    public View getView(final int i, View view, ViewGroup parent) {
        view = inflater.inflate(R.layout.history_app_content_main,null);
